  ...
  return (
    <div className="flex">
      ...
      <div className="flex-1 flex flex-col" style={{ height: "100svh", overflow: "hidden" }}>
        <Topbar title={pathname === "/" ? "Главная" : pathname === "/admins" ? "Администраторы" : pathname === "/users" ? "Пользователи" : pathname === "/transactions" ? "Транзакции" : pathname === "/control" ? "Фин. контроль" : pathname === "/control-cases" ? "Кейсы фин контроля" : pathname === "/rates" ? "Проценты" : pathname === "/faq" ? "FAQ" : ""} />
