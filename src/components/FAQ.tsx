  ...
  return (
    <div className="space-y-3">
      ...
      <Item id="transactions" q="Транзакции">
        <p>
          Аналитика переводов с фильтрами по датам, статусам, валютам и типам операций. График по метрикам «Сумма»/«Количество» с группировкой по дням/неделям/месяцам. Доступен экспорт данных графика в CSV через плавающую кнопку.
        </p>
      </Item>
